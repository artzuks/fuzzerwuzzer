...
## Fuzzing IP Layer <a name="fip" />
### Default Tests and Methodology <a name="ipdefault" />
...
### Tests From a File <a name="ipfile" />
#### File Format <a name="fileformat" />
Example:
```
...
## Fuzzing Application Layer <a name="fapp" />
...
### Random Payloads <a name="randompayloads" />
...
### Payloads From a File <a name="payloadsfromafile" />
...
### Validation of Pattern <a name="validationpattern" />
