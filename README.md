...
### High Level Usage <a name="high-level-usage"></a>
```
...
## Fuzzing IP Layer <a name="fip"></a>
### Default Tests and Methodology <a name="ipdefault"></a>
...
### Tests From a File <a name="ipfile"></a>
...
## Fuzzing Application Layer <a name="fapp"></a>
...
### Random Payloads <a name="randompayloads"></a>
...
### Payloads From a File <a name="payloadsfromafile"></a>
...
## Included Server <a name="server"></a>
...
### Validation of Pattern <a name="validationpattern"></a>
